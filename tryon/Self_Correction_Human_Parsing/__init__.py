from tryon.Self_Correction_Human_Parsing import networks
from tryon.Self_Correction_Human_Parsing.utils.transforms import get_affine_transform, transform_logits
...
class SelfCorrectionHumanParsing:
    def __init__(self, checkpoint_path, device):
        dataset_type = None
        if 'lip' in checkpoint_path:
            dataset_type = 'lip'
        elif 'atr' in checkpoint_path:
            dataset_type = 'atr'
        elif 'pascal' in checkpoint_path:
            dataset_type = 'pascal'
